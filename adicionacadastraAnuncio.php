    	...
    	<section class="conteudo">
            <div class="titulo">
            	...
            	<div class="Cadastrotipo">
                    <form class="form-adicionar" method="post" action="meusAnuncios.php">
                        ...
                        <input class="form-control" type="text" name="modeloCarro" placeholder="Digite o Modelo do Carro" required>
