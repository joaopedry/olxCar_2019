                 ...
                 if((isset($_GET["acao"])) AND ($_GET["acao"] == "AtualizarMeuAnuncio") AND (isset($_GET["id"])))
                {
                    ...
                    while($selecAnuncio = mysqli_fetch_assoc($anuncio)){?>
                        <form class="form-adicionar" method="post" action="editar.php" enctype="multipart/form-data">
                            ...
                            <input class="form-control" type="text" name="modeloCarro" placeholder="Digite o Modelo do Carro" value="<?php echo $selecAnuncio['ds_modelo']; ?> " required>
                            <label>Cor do carro</label>	
                            <select class="form-control" name="corCarro" required>
                            ...
                            <input class="form-control" type="text" placeholder="Preço" maxlength="20" name="precoCarro" value="<?php echo $selecAnuncio['ds_preco']; ?>" required>
